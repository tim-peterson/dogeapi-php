...
class DogeAPI
{
    ...
    private function _request($method, $path, $args = array(), $api_key=true, $api_version='v1')
    {
        
        // Check API version
        if($api_version=='v1') $uri2='';
        else $uri2='/'.$api_version.'/';
        
        // Generate cURL URL
        if($api_key==true) $url =  'https://www.dogeapi.com/wow/'.$uri2.'?api_key=' . $this->api_key . $path;
        else $url =  'https://www.dogeapi.com/wow/'.$uri2.'?a=' . $path;
...
//https://www.dogeapi.com/api_documentation_v2
    ...
    public function create_user($args = array(), $api_version='v2')
    {
    ...
    public function get_user_address($args = array(), $api_version='v2')
    {
...
// /wow/v2/?api_key={API_KEY}&a=get_user_balance&user_id={USER_ID}
    public function get_user_balance($args = array(), $api_version='v2')
    {
...
// /wow/v2/?api_key={API_KEY}&a=withdraw_from_user&user_id={USER_ID}&pin={PIN}&amount_doge={AMOUNT_DOGE}&payment_address={PAYMENT_ADDRESS}
    ...
    public function withdraw_from_user($args = array(), $api_version='v2')
    {
...
// /wow/v2/?api_key={API_KEY}&a=move_to_user&to_user_id={TO_USER_ID}&from_user_id={FROM_USER_ID}&amount_doge={AMOUNT_DOGE}
    ...
    public function move_to_user($args = array(), $api_version='v2')
    {
...
// /wow/v2/?api_key={API_KEY}&a=get_users
    public function get_users($args = array(), $api_version='v2')
    {
...
// /wow/v2/?api_key={API_KEY}&a=get_transactions&num={NUMBER}&type={TYPE}
    public function get_transactions($args = array(), $api_version='v2')
    {
...
///wow/v2/?a=get_network_hashrate
    public function get_network_hashrate($api_key=false, $api_version='v2')
    {
...
///wow/v2/?a=get_info 
    public function get_info($api_key=false, $api_version='v2')
    {
